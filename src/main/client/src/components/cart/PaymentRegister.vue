  ...
  <div>
    <form @submit.prevent>
      <div>
        ...
        <input type="text" name="username" id="username" placeholder="Account Name" v-model="username" />
        <span class="text-danger" v-if="!$v.username.required && $v.username.$dirty">Field is required</span>
        <span class="text-danger"
              v-if="!$v.username.minLength && $v.username.$dirty">Username must have at least {{ $v.username.$params.minLength.min }} letters.</span>
      </div>
      <div>
        ...
        <span class="text-danger"
              v-if="!$v.password.minLength && $v.password.$dirty">Password must have at least {{ $v.password.$params.minLength.min }} letters.</span>
