...
export const baseFonts = {
  sans: "CircularStdBook,\"Segoe UI\",Roboto,\"Helvetica Neue\",Arial,\"Noto Sans\",sans-serif,\"Apple Color Emoji\",\"Segoe UI Emoji\",\"Segoe UI Symbol\",\"Noto Color Emoji\"",
  serif: "CircularStdBook,Georgia,Cambria,\"Times New Roman\",Times,serif",
  mono: "CircularStdBook,Monaco,Consolas,\"Liberation Mono\",\"Courier New\",monospace",
}
